...
export const QUERY_PERMISSIONS: {
	...
	CLIENT: {
		...
		GET_COLLECTION_ACTUALISATION: or(PermissionName.VIEW_COLLECTION_EDITORIAL_OVERVIEWS),
		GET_COLLECTION_QUALITY_CHECK: or(PermissionName.VIEW_COLLECTION_EDITORIAL_OVERVIEWS),
		GET_COLLECTION_MARCOM: or(PermissionName.VIEW_COLLECTION_EDITORIAL_OVERVIEWS),
		INSERT_COLLECTION_MANAGEMENT_ENTRY: or(PermissionName.VIEW_COLLECTION_EDITORIAL_OVERVIEWS),
		UPDATE_COLLECTION_MANAGEMENT_ENTRY: or(PermissionName.VIEW_COLLECTION_EDITORIAL_OVERVIEWS),
		INSERT_COLLECTION_MANAGEMENT_QC_ENTRY: or(
	...
	PROXY: {
		...
		GET_PUBLIC_COLLECTIONS_OR_BUNDLES: ALL_LOGGED_IN_USERS,
		...
		GET_CONTENT_PAGES_FOR_OVERVIEW_BLOCK: ALL_LOGGED_IN_USERS,
		...
		GET_ITEM_MEDIA_PLAYER_INFO_BY_EXTERNAL_ID: ALL_LOGGED_IN_USERS,
		GET_ITEM_BROWSE_PATHS_BY_IDS: ALL_LOGGED_IN_USERS,
	},
};
