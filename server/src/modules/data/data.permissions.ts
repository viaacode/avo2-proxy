...
export const QUERY_PERMISSIONS: {
	...
	CLIENT: {
		...
		GET_COLLECTION_ACTUALISATION: or(
			PermissionName.VIEW_COLLECTION_EDITORIAL_OVERVIEWS,
			PermissionName.VIEW_BUNDLE_EDITORIAL_OVERVIEWS
		),
		GET_COLLECTION_QUALITY_CHECK: or(
			PermissionName.VIEW_COLLECTION_EDITORIAL_OVERVIEWS,
			PermissionName.VIEW_BUNDLE_EDITORIAL_OVERVIEWS
		),
		GET_COLLECTION_MARCOM: or(
			PermissionName.VIEW_COLLECTION_EDITORIAL_OVERVIEWS,
			PermissionName.VIEW_BUNDLE_EDITORIAL_OVERVIEWS
		),
		INSERT_COLLECTION_MANAGEMENT_ENTRY: or(
			PermissionName.VIEW_COLLECTION_EDITORIAL_OVERVIEWS,
			PermissionName.VIEW_BUNDLE_EDITORIAL_OVERVIEWS
		),
		UPDATE_COLLECTION_MANAGEMENT_ENTRY: or(
			PermissionName.VIEW_COLLECTION_EDITORIAL_OVERVIEWS,
			PermissionName.VIEW_BUNDLE_EDITORIAL_OVERVIEWS
		),
		...
		GET_MARCOM_ENTRIES: or(
			PermissionName.VIEW_COLLECTION_EDITORIAL_OVERVIEWS,
			PermissionName.VIEW_BUNDLE_EDITORIAL_OVERVIEWS
		),
		INSERT_MARCOM_ENTRY: or(
			PermissionName.VIEW_COLLECTION_EDITORIAL_OVERVIEWS,
			PermissionName.VIEW_BUNDLE_EDITORIAL_OVERVIEWS
		),
	},
