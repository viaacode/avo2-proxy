...
const VIEW_AND_EDIT_EDITORIAL_PROPS = or(
...
export const QUERY_PERMISSIONS: {
	...
	CLIENT: {
		...
		DELETE_CONTENT_BLOCK: or(
			PermissionName.EDIT_ANY_CONTENT_PAGES,
			PermissionName.DELETE_ANY_CONTENT_PAGES
		),
		GET_CONTENT_PAGE_LABELS: insertOrUpdateContentBlocks,
		...
		GET_USER_GROUPS_WITH_FILTERS: or(
		...
		GET_ORGANISATIONS_WITH_USERS: ALL_LOGGED_IN_USERS,
		...
		GET_COLLECTION_ACTUALISATION: VIEW_AND_EDIT_EDITORIAL_PROPS,
		GET_COLLECTION_QUALITY_CHECK: VIEW_AND_EDIT_EDITORIAL_PROPS,
		GET_COLLECTION_MARCOM: VIEW_AND_EDIT_EDITORIAL_PROPS,
		INSERT_COLLECTION_MANAGEMENT_ENTRY: VIEW_AND_EDIT_EDITORIAL_PROPS,
		UPDATE_COLLECTION_MANAGEMENT_ENTRY: VIEW_AND_EDIT_EDITORIAL_PROPS,
		INSERT_COLLECTION_MANAGEMENT_QC_ENTRY: VIEW_AND_EDIT_EDITORIAL_PROPS,
		GET_MARCOM_ENTRIES: VIEW_AND_EDIT_EDITORIAL_PROPS,
		INSERT_MARCOM_ENTRY: VIEW_AND_EDIT_EDITORIAL_PROPS,
		INSERT_MARCOM_NOTE: VIEW_AND_EDIT_EDITORIAL_PROPS,
		UPDATE_MARCOM_NOTE: VIEW_AND_EDIT_EDITORIAL_PROPS,
		DELETE_MARCOM_ENTRY: VIEW_AND_EDIT_EDITORIAL_PROPS,
	},
	PROXY: {
		...
		GET_ITEM_BROWSE_PATH_BY_EXTERNAL_ID: ALL_LOGGED_IN_USERS,
		GET_ITEM_PIDS_AND_BROWSE_PATHS_BY_IDS: ALL_LOGGED_IN_USERS,
	},
};
