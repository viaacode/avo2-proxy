...
describe('Sanitizer helper', () => {
	it('Should remove all unallowed tags when using the `basic` preset', () => {
		const input = '<html><p>Hello! <a href="https://www.test.com">www.test.com</a></p>  <span>testing</span> <ul><li>item</li></ul></html>';
	...
	it('Should remove all unallowed tags and attributes when using the `link` preset', () => {
		const input = '<html><p>Hello! <a href="https://www.test.com" rel="noreferrer">www.test.com</a></p>  <span>testing</span> <ul><li>item</li></ul></html>';
